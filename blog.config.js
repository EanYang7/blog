...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ean Yang', // 您的昵称 例如 Ean Yang
  BIO: process.env.NEXT_PUBLIC_BIO || '不会打篮球🏀的健身爱好者💪不是好程序猿🧑‍💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/YQisme', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yangqi7isme@163.com', // 邮箱地址 例如yangqi7isme@163.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/YQisme', // 你的github个人主页 例如 https://github.com/YQisme
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/244185393', // B站主页
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-KLKV4TGEV8', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '不只博客，还有知识管理', // 站点描述，被notion中的页面描述覆盖
