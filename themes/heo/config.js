const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-10-06', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://eanyang7.com' },
    { title: '访问文档中心获取更多帮助', url: 'EanYang7.github.io' }
  ],
  ...
  INFO_CARD_URL: 'https://github.com/EanYang7/blog/', // 个人资料底部按钮链接
  ...
  SOCIAL_CARD_TITLE_1: '留言平台',
  SOCIAL_CARD_TITLE_2: '欢迎大家 留言&咨询&讨论',
  SOCIAL_CARD_TITLE_3: '点击进入→',
  SOCIAL_CARD_URL: 'https://github.com/EanYang7/blog/discussions',
